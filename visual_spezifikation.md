...
| 5 | LF5 | **Zwei Balken**: links Schülerstruktur je Schulart (Input, **fest Deutschland – nur DE-Ebene verfügbar**), rechts **Abgänge ohne HSA je Schulart** (Antwort, **reagiert auf Bundesland-Filter**) | links Achse `dim_schulart` / `[Schüleranteil %]` (Titel „…fest: Deutschland 2023, nur DE-Ebene verfügbar"); rechts Achse `fact_abgaenge_schulart[schulart]` / `[Abgänge ohne HSA (Schulart)]` (Titel „…reagiert auf Bundesland-Filter"), Förderschulen akzentuiert | links `ebene=DE` (fest); rechts Landesebene, Deutschland-Default | „Der Schulartmix prägt die Verteilung: Förderschulen stellen 42 % (23.324) der Abgänge ohne HSA. Links fest Deutschland, rechts filterbar" | `charts/LF5_schulartmix.png` + PBI-Seite LF5 |
